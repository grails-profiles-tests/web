...
cp $GITHUB_WORKSPACE/build/grails-profiles-tests/web/build/grails-wrapper/wrapper/build/libs/grails5-wrapper-3.0.0.BUILD-SNAPSHOT.jar $HOME/.grails/wrapper/grails5-wrapper.jar
